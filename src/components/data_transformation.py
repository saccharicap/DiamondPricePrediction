...
# from sklearn.compose import ColumnTransformer ## for joining different pipelinne
# import sys
# import os
...
#             ## define the custom ranking for each columns
...
#             logging.info('cat_pipeline and num_pipeline created')

#             ## joining both pipeline
...
#             logging.info('columnstransform is done')
#             return preprocessor, logging.info('pipeline complete')
...
#            ## freature into independent and dependent features
...
#            logging.info('splitting of dependent and independent feature done')
